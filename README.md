...
const response = await einvoice.issueInvoice({
  ...
  // Optional fields
  buyerIdentifier: '12345678', // buyer's tax ID (統一編號); presence determines B2B invoice
  invoiceType: 1, // 1: 一般稅額 VAT (default), 2: 特種稅額 (金融業/特種飲食業等)
  carrier: { type: 1, number: '/ABC1234' }, // 0: 會員載具, 1: 手機條碼載具, 2: 自然人憑證載具
  npoban: '8888', // donation code (捐贈碼)
  requestId: 'MY-UNIQUE-REQ-001', // optional; auto-generated by TapPay if omitted
});
